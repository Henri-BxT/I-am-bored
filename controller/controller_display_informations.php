...
if(!empty($data)){
    ...
    if(!empty($data)){
        ...
        if(!empty($data[0])){
            echo "<br><a href='controller_manage_list.php?favorit=remove&id=".$_REQUEST['id']."&media=movie'><img src='../ressources/icons/unfavorit.png' width='50px' height='50px'></a>";
        }else{
            ...
            echo "<br><a href='controller_manage_list.php?favorit=add&id=".$_REQUEST['id']."&media=movie'><img src='../ressources/icons/favorit.png' width='50px' height='50px'></a>";
        }
    }else{
